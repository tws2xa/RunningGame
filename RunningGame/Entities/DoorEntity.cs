...
namespace RunningGame.Entities {
    ...
    public class DoorEntity : Entity {
        ...
        //-------------------------------------------Constructors--------------------------------------------
        public DoorEntity( Level level, float x, float y, float w, float h ) {
            //Set level.
            ...
            //Add the components.
            //Leave this for all entities.
            addMyComponents( x, y, Int32.MinValue, w, h );
        }
        public DoorEntity( Level level, int id, float x, float y, float w, float h ) {
            //Set level.
            //Leave for all entities
            this.level = level;
        ...
        public DoorEntity( Level level, float x, float y, int switchId, float w, float h ) {
            //Set level.
            //Leave for all entities
            this.level = level;
            ...
            //Add the components.
            //Leave this for all entities.
            addMyComponents( x, y, switchId, w, h );
        }
        public DoorEntity( Level level, int id, float x, float y, int switchId, float w, float h ) {
            //Set level.
            //Leave for all entities
            this.level = level;
        ...
        public void addMyComponents( float x, float y, int switchId, float width, float height ) {
